...
Vexum's frontmatter contract (`type`/`id`/`title` required, per the
[`workspace.v1` schema](https://github.com/Vexa-ai/vexa-core/blob/main/core/agent/contracts/workspace.v1/workspace.schema.json))
...
tools — nothing about it is Vexum-specific.
