...
```
ws://localhost:8056/ws          # header:  X-API-Key: <API_KEY>
ws://localhost:8056/ws?api_key=<API_KEY>
```
...
const ws = new WebSocket("ws://localhost:8056/ws", { headers: { "X-API-Key": process.env.API_KEY } });
